"""Pydantic schemas for Supervisor Agent — request/response validation."""
...
# === Supervisor Alert Mapping ===
ALERT_RESOURCE_MAP: dict[str, str] = {
    "SupervisorProcessDown": "PROCESS",
    "SupervisorProcessFatal": "PROCESS",
    "SupervisorProcessExited": "PROCESS",
    "SupervisorProcessBackoff": "PROCESS",
    "SupervisorProcessRestarting": "PROCESS",
}

SUPERVISOR_ALERT_NAMES = set(ALERT_RESOURCE_MAP.keys())
...
class ApprovalRequest(BaseModel):
    ...
    decided_by: str = "operator"
    reason: Optional[str] = None
    selected_commands: Optional[list[int]] = None
...
# === LLM Response Schema (host-resource compatibility) ===
