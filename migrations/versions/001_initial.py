...
def upgrade() -> None:
    ...
    op.create_table('alerts_normalized',
        ...
        sa.Column('alert_key', sa.String(512), nullable=False, index=True),
    ...
    op.create_table('incidents',
        ...
        sa.Column('canonical_root_cause', sa.String(512)),
        sa.Column('issue_subtype', sa.String(255)),
        sa.Column('root_cause_signature_v2', sa.String(1024), index=True),
    ...
    op.create_table('remediation_knowledge',
        ...
        sa.Column('alert_name', sa.String(255), nullable=False, index=True),
        sa.Column('resource_type', sa.String(50), nullable=False),
        sa.Column('canonical_root_cause', sa.String(512), nullable=False, index=True),
        sa.Column('issue_subtype', sa.String(255), server_default=''),
        sa.Column('root_cause_signature_v2', sa.String(1024), index=True),
        sa.Column('short_title', sa.String(512)),
    ...
    op.create_table('incident_patterns',
        ...
        sa.Column('root_cause_signature_v2', sa.String(1024)),
        sa.Column('description', sa.Text()),
